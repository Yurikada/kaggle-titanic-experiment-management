...
print("added feature: FamilySize = SibSp + Parch + 1")
...
summary_path = REPORT_DIR / "depth4_family_size_multi_split_summary.csv"
errors_path = REPORT_DIR / "depth4_family_size_multi_split_errors.csv"
